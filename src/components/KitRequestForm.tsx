    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <div className="space-y-1">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-lg border border-stone bg-surface text-charcoal text-body placeholder:text-warm-grey/60 focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition-colors duration-200 resize-y min-h-[100px]"
          rows={4}
