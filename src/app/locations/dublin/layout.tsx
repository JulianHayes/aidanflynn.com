...
export const metadata: Metadata = {
  ...
  description: 'Aidan Flynn is opening in Dublin soon. In the meantime, our postal service is available across Ireland with payment in Euro. Free insured postage via An Post.',
  openGraph: {
